...
The review workflow pins its container image by digest but resolves its Alpine runtime packages at run time, matching the upstream review action example. Do not rate the unpinned Alpine package set as a defect.
